		...
		<div class="modal-content">
			<div class="modal-body modal-body-sub_agile">
				<div class="col-md-8 modal_body_left modal_body_left1">
					...
					<p>Welcome to SnatchKart!</p>
					<p>These terms and conditions outline the rules and regulations
						for the use of SnatchKart's Website, located at
						www.snatchkart.com.</p>
					<p>By accessing this website we assume you accept these terms
						and conditions. Do not continue to use SnatchKart if you do not
					...
					<p>The following terminology applies to these Terms and
						...
						log on this website and compliant to the Company terms and
						...
						the express purpose of meeting the Client needs in respect of
					...
					<p>We employ the use of cookies. By accessing SnatchKart, you
						agreed to use cookies in agreement with the SnatchKart's Privacy
						Policy.</p>
					...
					<p>Unless otherwise stated, SnatchKart and/or its licensors own
						the intellectual property rights for all material on SnatchKart.
						All intellectual property rights are reserved. You may access this
						from SnatchKart for your own personal use subjected to
						restrictions set in these terms and conditions.</p>
					<p>You must not:</p>
					<ul>
						<li>Republish material from SnatchKart</li>
						<li>Sell, rent or sub-license material from SnatchKart</li>
						<li>Reproduce, duplicate or copy material from SnatchKart</li>
						<li>Redistribute content from SnatchKart</li>
					</ul>
					...
					<p>Parts of this website offer an opportunity for users to post
						...
						website. SnatchKart does not filter, edit, publish or review
						Comments prior to their presence on the website. Comments do not
						reflect the views and opinions of SnatchKart,its agents and/or
						...
						applicable laws, SnatchKart shall not be liable for the Comments
					...
					<p>SnatchKart reserves the right to monitor all Comments and to
					...
					<p>You hereby grant SnatchKart a non-exclusive license to use,
					...
					<p>We will approve link requests from these organizations if we
						...
						SnatchKart; and (d) the link is in the context of general resource
						information.</p>
					...
					<p>If you are one of the organizations listed in paragraph 2
						...
						inform us by sending an e-mail to SnatchKart. Please include your
					...
					<ul>
						...
						<li>By use of any other description of our Website being
							...
							content on the linking party site.</li>
					</ul>
					<p>No use of SnatchKart's logo or other artwork will be allowed
					...
					<p>We reserve the right to request that you remove all links or
						...
						right to amen these terms and conditions and it's linking policy
						at any time. By continuously linking to our Website, you agree to
					...
					<p>If you find any link on our Website that is offensive for
						any reason, you are free to contact and inform us any moment. We
					...
					<p>As long as the website and the information and services on
