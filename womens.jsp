...
<body>
	...
	<div class="page-head_agile_info_w3l" style="background: url(images/inner1.jpg) no-repeat center;">
		<div class="container">
			<h3>
			...
			<div class="col-md-12 products-right">
				...
				<div class="men-wear-bottom">
					...
					<div class="col-sm-8 men-wear-right">
						<h4>
							Exclusive Women's <span>Collections</span>
						</h4>
						<p class="text-justify">There are unlimited options if you
							wish to buy women clothes online india, as there are a large
							number of clothing stores for women online. But women clothes website
							SnatchKart.com is the best among them all. Here, you can buy womens
							clothes and mens fashion clothing. So, by visiting online fashion
							store india, you can do womens fashion online shopping and flaunt a
							different wardrobe style, every single day. When doing formal
							dress online shopping for women, remember that clothing online
				...
				<div id="horizontalTab">
					<ul class="resp-tabs-list">
						<%
							...
							try {
								ResultSet rs = db.getSubCategoryBycid("66");
								while (rs.next()) {
									cid[i] = rs.getInt("sid");
									i++;
						%>
											...
											<form action="#" method="post">
												<fieldset>
													...
													<input type="hidden" name="amount"
														value="<%=rs.getInt("regprice")%>" /> <input
