...
<body>
	...
	<%@include file="imgbanner.jsp"%>
	<%@include file="fallahead.jsp"%>
								...
								<div class="men-thumb-item">
									...
									<div class="men-cart-pro">
										<div class="inner-men-cart-pro">
											<a href="single.jsp?pid=<%=rs.getInt("pid")%>"
										...
										<form action="checkout.jsp" method="post">
											<fieldset>
												<input type="hidden" name="cmd" value="_cart" /> <input
													type="hidden" name="add" value="<%=rs.getString("pid")%>" />
												...
												<input type="hidden" name="amount"
													value="<%=rs.getInt("regprice")%>" /> <input type="hidden"
													name="shipping" value="<%=rs.getInt("regprice")%>" /> <input
	...
	<!-- //new_arrivals -->
	<%@include file="whatstrending.jsp"%>
